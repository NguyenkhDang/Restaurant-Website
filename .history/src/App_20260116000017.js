        ...
        <div className="foodContainer">
          <div>
            ...
            <p>Beef pho is a Vietnamese noodle soup made with a clear, aromatic beef broth simmered with spices like star anise and cinnamon. It’s served with flat rice noodles, thinly sliced beef, and fresh herbs such as basil and cilantro, with lime and chili on the side for added flavor.
             ...
             {showMore && <span className="allergies"id="allergies">
                <h2>Allergies</h2>
                <ul>
                  <li><span id="label">Soy:</span>  hoisin sauce, soy sauce</li>
                  <li><span id="label">Fish:</span> fish sauce in the broth</li>
                  <li><span id="label">Gluten:</span>Gluten: possible in soy/hoisin sauces (rice noodles are gluten-free)</li>
                  <li><span id="label">Shellfish:</span>Shellfish: may be present if seafood-based sauces are used</li>
                  <li><span id="label">Spices:</span>Spices: star anise, cinnamon, cloves (can affect spice-sensitive individuals)</li>
                </ul>
              </span>}
            </p>
            <button onClick={() => setShowMore(!showMore)} id="myBtn">
