      ...
      <div className="menu">
        ...
        <div className="foodContainer">
          <div>
            ...
            <h2>Beef Pho</h2>
            <p>Beef pho is a Vietnamese noodle soup made with a clear, aromatic beef broth simmered with spices like star anise and cinnamon. It’s served with flat rice noodles, thinly sliced beef, and fresh herbs such as basil and cilantro, with lime and chili on the side for added flavor. </p>
          </div>
          <div>
            <img  src={ChickenPho}
                  style={{width: "15vw", height: "30vh"}}/>
