          ...
          <div className="foodContainer">
            ...
            <div>
              <img  src={VeganPho}
                    style={{width: "15vw", height: "30vh"}}/>
              <h2>Item</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sed imperdiet ante. Nam tellus eros, porta a nisl id, tincidunt porttitor velit. Ut faucibus quam gravida mollis tempus. Sed tellus libero, luctus id dictum ut, tincidunt nec dui. Quisque tincidunt est sit amet facilisis congue. Vestibulum vulputate, nisi in pulvinar semper, urna enim gravida ipsum, in cursus erat quam sit amet nisl. Aliquam eu convallis neque. Donec sit amet est vel ipsum laoreet sollicitudin sed id nibh. Fusce rhoncus gravida lorem, non vulputate felis ullamcorper vitae. Sed id tincidunt mi. Vestibulum velit tellus, varius non ex varius, elementum condimentum massa. Etiam nec arcu bibendum lorem suscipit feugiat non vel eros. Donec quis neque at ante euismod pulvinar. Curabitur posuere sed libero sed egestas. Praesent condimentum consequat posuere.</p>
            </div>
          </div>
        </div>
    </div>
